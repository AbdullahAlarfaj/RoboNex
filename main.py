...
class MainController:
    ...
    def setup_keyboard(self):
        keyboard.on_press_key('space', lambda _: self.handle_space())
        keyboard.on_press_key('ctrl', lambda _: self.switch_programs())
        keyboard.on_press_key('q', lambda _: self.safe_exit())
